      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <Section title="6. Your Rights">
            ...
            <p className="mt-4">To exercise your rights, contact us at: <a href="mailto:growth@createhookx.com" className="text-[#765EEF] hover:underline">growth@createhookx.com</a></p>
          </Section>
          ...
          <Section title="8. Contact Us">
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <p className="flex items-center text-gray-800">
                ...
                <a href="mailto:growth@createhookx.com" className="text-[#765EEF] hover:underline">growth@createhookx.com</a>
              </p>
            </div>
          </Section>
